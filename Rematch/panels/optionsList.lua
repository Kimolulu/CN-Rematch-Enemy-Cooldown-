...
rematch.optionsList = {
    ...
    {type="dropdown", group=24, text="敌对冷却文字大小", var="EnemyAbilityRemainingFontSize", func="EnemyAbilityBar",
    ...
    {type="dropdown", group=24, text="敌对冷却图标X轴", var="EnemyAbilityCooldownX", func="EnemyAbilityBar",
    ...
    {type="dropdown", group=24, text="敌对冷却图标Y轴", var="EnemyAbilityCooldownY", func="EnemyAbilityBar",
