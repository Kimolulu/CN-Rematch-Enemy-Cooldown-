...
rematch.optionsList = {
    ...
    -- 敌对技能冷却监控设置
    {type="header", group=24, text="敌对技能冷却监控设置"},
    {type="dropdown", group=24, text="敌对冷却字体大小", var="EnemyAbilityRemainingFontSize", func="EnemyAbilityBar",
        tooltip="Size of the cooldown number displayed in the center of enemy skill icons.",
    ...
    {type="dropdown", group=24, text="敌对冷却数字 X轴", var="EnemyAbilityCooldownX", func="EnemyAbilityBar",
        tooltip="Horizontal position of the centered cooldown number. Negative moves left; positive moves right.",
    ...
    {type="dropdown", group=24, text="敌对冷却数字 Y轴", var="EnemyAbilityCooldownY", func="EnemyAbilityBar",
        tooltip="Vertical position of the centered cooldown number. Negative moves down; positive moves up.",
        menu={{text="-12", value=-12},{text="-11", value=-11},{text="-10", value=-10},{text="-9", value=-9},{text="-8", value=-8},{text="-7", value=-7},{text="-6", value=-6},{text="-5", value=-5},{text="-4", value=-4},{text="-3", value=-3},{text="-2", value=-2},{text="-1", value=-1},{text="0", value=0},{text="1", value=1},{text="2", value=2},{text="3", value=3},{text="4", value=4},{text="5", value=5},{text="6", value=6},{text="7", value=7},{text="8", value=8},{text="9", value=9},{text="10", value=10},{text="11", value=11},{text="12", value=12}}},
        {type="dropdown", group=24, text="敌对冷却图标大小", var="EnemyAbilityIconSize", func="EnemyAbilityBar",
    ...
    {type="dropdown", group=24, text="敌对冷却图标间隙", var="EnemyAbilitySpacing", func="EnemyAbilityBar",
